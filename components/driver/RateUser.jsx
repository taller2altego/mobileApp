...
import { authPost, get, patch, handlerUnauthorizedError } from "../../utils/requests";
        ...
        <View style={{ flex: 1, alignItems: "center" }}>
            ...
            >
                <View style={Profilestyles.profile_container}>
                    ...
                    <Text style={Profilestyles.profile_visualization}>Pasajero: {userId}</Text>
                    {(userScore > 0) && (<Text style={Profilestyles.profile_visualization}>Puntaje del Viaje: {userScore}</Text>)}
